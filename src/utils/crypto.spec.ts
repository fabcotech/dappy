import { encrypt, decrypt, passwordFromStringToBytes } from './crypto';
...
describe('utils/account', () => {
  ...
  it('should right pad with zeros', () => {
    ...
    expect(passwordFromStringToBytes(password)).toEqual(passwordBytes);
  });
  it('should encrypt', () => {
    encrypted = encrypt(
  ...
  it('should decrypt', () => {
    decrypted = decrypt(encrypted, passwordBytes);
