...
describe('Accounts', () => {
  it('<UpdateBalancesButton /> should trigger update balances on click', () => {
    ...
    render(
      <UpdateBalancesButton disabled={true} updating={true} updateBalances={updateBalances} />
    );
    ...
    render(
      <UpdateBalancesButton disabled={false} updating={false} updateBalances={updateBalances} />
    );
  ...
  it('<HideBalancesButton /> hide balances on click', () => {
    ...
    render(
      <HideBalancesButton isBalancesHidden={true} toggleBalancesVisibility={toggleVisibility} />
    );
    ...
    render(
      <HideBalancesButton isBalancesHidden={false} toggleBalancesVisibility={toggleVisibility} />
    );
