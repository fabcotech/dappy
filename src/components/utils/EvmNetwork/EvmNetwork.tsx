...
// https://chainlist.org/
const getImgAndNetworkName = (chainId: string | undefined): { img: undefined | string, name: string } => {
  if (chainId === '1') {
    return {
      img: image_ethereum,
...
export const EvmNetwork = ({ chainId }: EvmNetworkProps) => {
  ...
  return (
    <React.Fragment>
      { chainId && typeof chainId === 'string' && <div className="field is-horizontal">
