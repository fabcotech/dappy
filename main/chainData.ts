// imported from package @debank/common (dist/chain-data.js)
...
export type ChainEnum = typeof CHAINS_ENUM[keyof typeof CHAINS_ENUM];
...
export interface ChainRaw {
  ...
  scanLink: string;
  thirdPartyRPC: string;
  nativeTokenDecimals: number;
  selectChainLogo?: string;
  eip: Record<string, boolean>;
}

export const CHAINS_RAW: Record<string, ChainRaw> = {
  [CHAINS_ENUM.ETH]: {
    id: 1,
    serverId: 'eth',
    name: 'Ethereum',
  ...
  [CHAINS_ENUM.BSC]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://bsc-dataseed1.binance.org',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.GNOSIS]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc.gnosischain.com',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.POLYGON]: {
    ...
    thirdPartyRPC: 'https://polygon-rpc.com',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.FTM]: {
    ...
    nativeTokenLogo:
      'https://static.debank.com/image/token/logo_url/eth/935ae4e4d1d12d59a99717a24f2540b5.png',
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc.ftm.tools',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.OKT]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://exchainrpc.okex.org',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.HECO]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://http-mainnet.hecochain.com',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.AVAX]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://api.avax.network/ext/bc/C/rpc',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.ARBITRUM]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://arb1.arbitrum.io/rpc',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.OP]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://mainnet.optimism.io',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.CELO]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://forno.celo.org',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.MOVR]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc.moonriver.moonbeam.network',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.CRO]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://evm-cronos.crypto.org',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.BOBA]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://mainnet.boba.network/',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.METIS]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://andromeda.metis.io/?owner=1088',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.BTT]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc.bittorrentchain.io/',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.AURORA]: {
    ...
    nativeTokenLogo:
      'https://static.debank.com/image/token/logo_url/eth/935ae4e4d1d12d59a99717a24f2540b5.png',
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://mainnet.aurora.dev',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.MOBM]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc.api.moonbeam.network',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.SBCH]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc-mainnet.smartbch.org',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.HMY]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://a.api.s0.t.hmny.io',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.FUSE]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc.fuse.io',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.ASTAR]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc.astar.network:8545',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.PALM]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://palm-mainnet.infura.io/v3/da5fbfafcca14b109e2665290681e267',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.SDN]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://evm.shiden.astar.network',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.KLAY]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://public-node-api.klaytnapi.com/v1/cypress',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.RSK]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://public-node.rsk.co',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.IOTX]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://babel-api.mainnet.iotex.io',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.KCC]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc-mainnet.kcc.network',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.WAN]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://gwan-ssl.wandevs.org:56891',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.SGB]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://songbird.towolabs.com/rpc',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.EVMOS]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://eth.bd.evmos.org:8545',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.DFK]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://subnets.avax.network/defi-kingdoms/dfk-chain/rpc',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.TLOS]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://mainnet.telos.net/evm',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.SWM]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://avax-cra-rpc.gateway.pokt.network',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.NOVA]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://nova.arbitrum.io/rpc',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.CANTO]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://canto.evm.chandrastation.com',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.DOGE]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc.dogechain.dog',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.STEP]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc.step.network',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.KAVA]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://evm.kava.io',
    eip: {
      1559: true,
    },
  },
  [CHAINS_ENUM.MADA]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc-mainnet-cardano-evm.c1.milkomeda.com',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.CFX]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://evm.confluxrpc.com',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.BRISE]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://mainnet-rpc.brisescan.com',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.CKB]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://v1.mainnet.godwoken.io/rpc',
    eip: {
      1559: false,
    },
  },
  [CHAINS_ENUM.TOMB]: {
    ...
    nativeTokenDecimals: 18,
    thirdPartyRPC: 'https://rpc.tombchain.com',
    eip: {
      1559: false,
    },
  },
